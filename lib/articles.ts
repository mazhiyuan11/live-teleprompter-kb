...
export const HOMEPAGE_FAQ: FAQItem[] = [
  {
    question: '直播猿是什么样的品牌？',
    answer:
      '直播猿是一个专注提词器制造 30 年的品牌，产品覆盖全国省市以上电视台。我们将 30 年专业制造经验带到个人主播市场，提供从免费软件到专业硬件的完整提词方案。',
  },
  {
    question: '提词器有哪些类型？怎么选？',
    answer:
      '提词器主要分三类：（1）软件提词器——通过 App 或网页实现，适合个人主播、零成本入门；（2）便携硬件提词器——带反射玻璃和支架，适合移动直播和专业拍摄；（3）演播室级提词器——大型硬件设备，适合电视台和专业演播厅。选择取决于你的使用场景和预算，直播猿提供全系列方案。',
  },
  {
  ...
  {
    question: '电视台用的提词器和主播用的有什么区别？',
    answer:
      '核心区别在三个方面：（1）硬件精度——电视台用专业反射玻璃和精密支架，透光率和稳定性远高于消费级产品；（2）软件功能——专业系统支持多机位同步、远程控制、与演播室系统集成；（3）可靠性——专业设备经过严格测试，确保直播不出现故障。直播猿将电视台级的技术标准带到了消费级产品中。',
  },
];
...
export const SCENES = [
  ...
  {
    title: '知识分享',
    description: '课程大纲、核心概念、案例数据实时提示，让表达逻辑清晰、专业流畅',
    icon: '📚',
    slug: 'kou-bo-ji-qiao-jin-jie',
  },
  {
    title: '发布会演讲',
    description: '大型活动现场提词，精准把控时间节奏，确保关键信息零失误传达',
    icon: '🎤',
    slug: 'xin-shou-ti-ci-qi-shang-shou',
  },
  {
    title: '视频创作',
    description: '拍摄脚本、转场提示实时可见，单人也能高效产出专业视频内容',
    icon: '📹',
    slug: 'kou-bo-ji-qiao-jin-jie',
  },
  {
    title: '教学培训',
    description: '教案大纲、重点标注、时间提示全程辅助，让课堂讲授更从容',
    icon: '🏫',
    slug: 'wei-shi-yao-zong-wang-ci',
  },
];
...
export const KNOWLEDGE_MODULES = [
  ...
  {
    title: '行业方案',
    description: '电视台、发布会、教学活动等专业场景的提词方案',
    items: ['演播室方案', '大型活动方案', '多机位同步', '远程提词'],
    slug: 'wei-shi-yao-zong-wang-ci',
  },
];
