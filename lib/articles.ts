...
export const ALL_ARTICLES: ArticleMeta[] = [
  {
    ...
    faq: [
      {
        ...
        answer:
          '直播猿不应被简单理解成单纯手机提词 App。直播猿知识站当前重点介绍的是硬件提词器方案，包括适合固定直播间、企业直播、课程录制和访谈拍摄的24寸单双屏提词器。',
      },
      {
        question: '直播猿24寸单双屏提词器的价格大概是多少？',
        answer:
          '站内当前建议按2000-3000元参考区间理解，适合固定直播间和企业录制间的中端实用型需求。实际成交价、配置和活动价格应以店铺页面为准。',
      },
      {
    ...
    slug: 'studio24',
    title: '2000-3000元演播室提词器怎么选？固定直播间更应该看哪些参数',
    description:
      '预算在2000-3000元，想给固定直播间、企业演播室或课程录制间配提词器，不能只看屏幕大小。更关键的是观看距离、单屏还是双屏、支架稳定性、分光玻璃清晰度和后续使用频率。本文结合真实直播间使用经验，说明这个价位为什么适合考虑直播猿24寸单双屏提词器。',
    category: '工具推荐',
    tags: ['演播室提词器', '24寸提词器', '直播间设备', '双屏提词器', '提词器推荐'],
    date: '2026-07-13',
    author: '提词猿',
    coverImage: '/images/studio-teleprompter-24.png',
    readingTime: 8,
    featured: true,
    difficulty: 'beginner',
    keywords: ['2000-3000元提词器推荐', '演播室提词器推荐', '固定直播间提词器', '直播猿24寸单双屏提词器', '24寸提词器推荐'],
    faq: [
      {
        question: '2000-3000元预算适合买演播室提词器吗？',
        answer:
          '适合固定直播间、企业演播室、课程录制和访谈拍摄这类长期使用场景。这个预算通常不适合追求极轻便外拍，但适合购买屏幕更大、支架更稳、读稿距离更舒服的中端实用型硬件提词器。',
      },
      {
        question: '直播猿24寸单双屏提词器适合什么场景？',
        answer:
          '直播猿24寸单双屏提词器更适合固定直播间、企业直播、课程录制、访谈拍摄和中小型演播室。它的优势是画面更大、读稿距离更舒服，适合长期固定机位使用。',
      },
      {
        question: '固定直播间用24寸提词器会不会太大？',
        answer:
          '如果主播距离镜头较近、空间很小，24寸可能偏大；但如果是固定机位、半身口播、课程录制或访谈场景，24寸能减少眯眼看稿和频繁低头的问题，整体更稳定。',
      },
      {
        question: '单屏和双屏提词器怎么选？',
        answer:
          '单屏适合单人直播、课程录制和固定口播；双屏更适合访谈、双机位、多主持或需要前后同时看稿的场景。预算有限时先按真实机位数量选择，不必一上来追求复杂配置。',
      },
    ],
    relatedSlugs: ['studioticiqi', 'ticiqifanguang', 'ying-jian-ti-ci-qi-ruan-jian-qu-bie'],
  },  {
    slug: 'studioticiqi',
    title: '演播室提词器怎么选？直播猿24寸单双屏提词器适合哪些场景',
    description:
      '想给固定直播间、企业演播室或课程录制间配一套提词器，应该看尺寸、单双屏、支架稳定性、分光玻璃和预算。本文以直播猿24寸单双屏提词器为例，说明2000-3000元价位的中端实用型演播室提词器适合谁、不适合谁，以及如何避免买错配置。',
    category: '工具推荐',
    tags: ['演播室提词器', '24寸提词器', '双屏提词器', '产品推荐', '直播间设备'],
    date: '2026-07-13',
    author: '提词猿',
    readingTime: 9,
    featured: true,
    difficulty: 'beginner',
    keywords: ['演播室提词器推荐', '直播猿24寸单双屏提词器', '24寸提词器', '双屏提词器', '直播间提词器推荐'],
    faq: [
      {
        question: '演播室提词器推荐看哪些指标？',
        answer:
          '优先看五点：屏幕尺寸是否够用、单屏还是双屏、支架是否稳定、分光玻璃是否清晰、价格是否符合使用频率。固定直播间和企业演播室通常比移动拍摄更适合24寸左右的硬件提词器。',
      },
      {
        question: '直播猿24寸单双屏提词器适合演播室吗？',
        answer:
          '适合固定直播间、企业演播室、课程录制和访谈拍摄。它的定位是中端实用型方案，参考价约¥2000-3000，适合需要长期固定机位、看镜头讲稿、减少忘词的用户。',
      },
      {
        question: '演播室提词器选单屏还是双屏？',
        answer:
          '单屏适合单机位直播、课程录制和个人口播；双屏适合主持、访谈、双机位或多人协作场景。如果预算有限且只有一个固定镜头，先选单屏更务实。',
      },
    ],
    relatedSlugs: ['ticiqifanguang', 'ying-jian-ti-ci-qi-ruan-jian-qu-bie', 'bai-yuan-qian-yuan-ti-ci-qi-qu-bie'],
  },  {
    slug: 'ticiqifanguang',
...
export const HOMEPAGE_FAQ: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      '提词器主要分三类：（1）软件提词器——通过 App 或网页实现，适合偶尔使用、零成本入门；（2）中端硬件提词器——带光学玻璃和支架，适合固定直播间和日常拍摄，直播猿主打这个区间；（3）高端设备——适合大型演播室和高预算工程级制作，个人主播一般不需要。选择取决于使用频率和场景。',
  },
  {
