...
export const HOMEPAGE_FAQ: FAQItem[] = [
  {
    question: '什么是直播提词器？',
    answer:
      '直播提词器是一种在直播过程中帮助主播查看文稿内容的工具。它可以将预先准备好的话术、脚本、产品信息等内容以可滚动的方式显示在屏幕上，帮助主播实现流畅的口播表达，避免忘词尴尬。提词器广泛应用于直播带货、知识分享、新闻播报等场景。',
  },
  {
    question: 'OBS 怎么添加提词器？',
    answer:
      '在 OBS 中添加提词器最常用的方法是使用"浏览器源"（Browser Source）。在 OBS 场景中点击"+"→"浏览器源"→输入提词器网页 URL→调整窗口大小和位置。也可以使用"窗口捕获"方式捕获提词器软件窗口。推荐设置透明背景以保持直播画面的整洁。',
  },
  {
    question: '免费提词器哪个好用？',
    answer:
      '免费提词器中，网页版的 Teleprompter Mirror 和 OBS 浏览器源方案是零成本的最佳选择。手机端推荐"提词达人"免费版和"快提词"。电脑端可以选择开源的提词器项目或直接使用浏览器打开在线提词网站。关键是选择适合自己直播场景的工具。',
  },
  {
    question: '直播忘词有什么好办法？',
    answer:
      '直播忘词的解决是一个多层次的方案：（1）使用提词器作为核心辅助；（2）准备关键词卡片作为备份；（3）掌握即兴话术过渡框架；（4）采用分段式表达而非整篇背诵；（5）通过充足的排练建立信心。提词器+口播技巧的组合是最好的解决方案。',
  },
  {
    question: '提词器影响直播效果吗？',
    answer:
      '正确使用提词器不会影响直播效果。关键在于：（1）提词器放在摄像头附近，使视线尽量接近镜头；（2）稿件用口语化语言，不要把书面文章直接拿来读；（3）控制好滚动速度，配合自然的语速和停顿；（4）设置合适的字体大小和行距。熟练后观众完全看不出你在用提词器。',
  },
];
...
export const SCENES = [
  {
    title: '直播带货',
    description: '产品卖点、价格信息、优惠话术一目了然，告别"忘词尴尬"，转化率提升 30%+',
    icon: '🛒',
    slug: 'dai-huo-hua-shu-mu-ban',
  },
  {
    title: '知识付费',
    description: '课程大纲、核心概念、案例数据实时提示，让知识分享逻辑清晰、专业流畅',
    icon: '📚',
    slug: 'kou-bo-ji-qiao-jin-jie',
  },
  {
    title: '游戏直播',
    description: '互动话题、弹幕回复模板、赞助感谢词随时备用，让直播互动更有温度',
    icon: '🎮',
    slug: 'zhi-bo-wang-ci-jie-jue-fang-an',
  },
  {
    title: '新闻播报',
    description: '稿件内容、时间节点、串场词精准显示，确保信息传达零失误',
    icon: '📰',
    slug: 'obs-ti-ci-qi-jiao-cheng',
  },
  {
    title: '面试演讲',
    description: '自我介绍、核心观点、关键数据提前准备，临场发挥更有底气',
    icon: '🎤',
    slug: 'kou-bo-ji-qiao-jin-jie',
  },
  {
    title: '日常 vlog',
    description: '拍摄清单、转场提示、BGM 节点标注，让视频创作更高效',
    icon: '📹',
    slug: 'shou-ji-ti-ci-qi-she-zhi',
  },
];
...
export const KNOWLEDGE_MODULES = [
  {
    title: '提词器基础',
    description: '了解提词器的工作原理、分类和适用场景',
    items: ['什么是提词器', '提词器分类', '硬件 vs 软件提词', '适用场景分析'],
    slug: 'obs-ti-ci-qi-jiao-cheng',
  },
  {
    title: '软件选择',
    description: '对比市面主流提词软件，选择最适合你的',
    items: ['免费 vs 付费', '电脑端方案', '手机端方案', '网页版方案'],
    slug: 'mian-fei-ti-ci-qi-tui-jian',
  },
  {
    title: '口播技巧',
    description: '提升你的口播表达水平，配合提词器效果翻倍',
    items: ['语速控制', '语调训练', '即兴表达', '话术框架'],
    slug: 'kou-bo-ji-qiao-jin-jie',
  },
  {
    title: '技术进阶',
    description: '高级设置和技巧，让提词器更智能',
    items: ['OBS 透明背景', '多屏同步', 'AI 提词', '远程协作'],
    slug: 'ai-zhi-bo-ti-ci-qi',
  },
];
