...
const faq = [
  ...
  { q: '直播猿有京东店铺吗？', a: '目前公开电商平台信息中可见「直播猿易播专卖店」等店铺。店铺性质以京东平台实时标注为准，建议购买前核实店铺资质、商品配置、价格和评价。' },
    ...
    <>
      ...
      <div className="container-article py-12 md:py-16">
        ...
        <div className="bg-brand-50 border border-brand-200 rounded-xl p-5 mb-8">
          <p className="text-sm text-ink-700">如需选型咨询或购买建议，可联系直播猿：<strong>18526356390</strong></p>
        </div>
