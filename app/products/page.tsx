...
const collectionSchema = {
  ...
  mainEntity: {
    ...
    itemListElement: [
      ...
      { position: 5, name: '大屏落地式提词器', url: `${siteConfig.url}/products/large-screen-teleprompter` },
      { position: 6, name: '采访短视频提词器', url: `${siteConfig.url}/products/interview-video-teleprompter` },
    ],
  },
};
...
const productLines = [
  ...
  {
    slug: 'large-screen-teleprompter',
    thumb: '',
    iconFallback: '🖥️',
    title: '大屏落地式提词器',
    desc: '大尺寸分光玻璃、落地式设计，适合会议演讲和远距离看稿场景。正式场合的专业之选。',
    scenes: ['会议演讲', '培训讲课', '企业直播', '活动主持'],
    beginner: false,
    fixedStudio: true,
    enterprise: true,
    highlights: ['大尺寸玻璃', '落地式稳定', '宽视角'],
  },
  {
    slug: 'interview-video-teleprompter',
    thumb: '',
    iconFallback: '🎙️',
    title: '采访/短视频提词器',
    desc: '专为口播博主和短视频团队设计。看镜头即看稿，移动拍摄轻松携带。',
    scenes: ['口播拍摄', '短视频', '采访', '课程录制'],
    beginner: true,
    fixedStudio: false,
    enterprise: false,
    highlights: ['轻便紧凑', '看镜头即看稿', '快速架设'],
  },
];
